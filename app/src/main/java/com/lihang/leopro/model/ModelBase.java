...
import com.lihang.leopro.bean.basebean.NetFailBean;
...
import com.lihang.leopro.okhttps.LoadingDialog;
                        ...
                        if (((ResponModel) successBean).getStatus() == 1) {
                            ...
                            if (paramsBuilder.isSuccessErrorOverrid()) {
                                ...
                                EasyOk.getInstance().getmDelivery().post(new Runnable() {
                                    @Override
                                    public void run() {
                                        netWorkListener.onNetCallBack(paramsBuilder.getCommand(), ((ResponModel) finalSuccessBean).getBody());
                                    }
                                });
                            } else {
